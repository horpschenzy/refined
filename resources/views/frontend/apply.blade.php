        ...
        <div class="section-space">
            <div class="container">
              ...
              {{-- <p>Application for Refined 2022 is now closed</p> --}}
                            <p>Book your slot in the upcoming 2025 Refined for Women in ministry by Pastor (Dr.) Funke
                                Obadje. We thank God 2024 was glorious, we believe God for much more in 2025</p>
                        </div>
                    </div>
                </div>
                {{-- <div class="row justify-content-center">
                    <div class="col-md-8">
                        <form action="/register" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <label class="checkbox-inline">Email<input style="margin-right: 5px;" name="prefer_com"
                                        type="radio" value="Email" required></label>
                                <label class="checkbox-inline">Telegram<input style="margin-right: 5px;" name="prefer_com"
                                        type="radio" value="Telegram" required></label>
                            </div>
                            <div class="form-group">
                                <label>Are you currently involved in ministry?*</label>
                                <label class="radio-inline">Yes<input style="margin-right: 5px;" type="radio"
                                        name="involved_in_ministry" value="yes" required></label>
                                <label class="radio-inline">No<input style="margin-right: 5px;" type="radio"
                                        name="involved_in_ministry" value="no" required></label>
                            </div>
                            <div class="form">
                            ...
                            <div class="form-group">
                                <label for="sel1">Are you a SetMan / G.O? (Do you pioneer a ministry work with your
                                    husband?)</span></label>
                                <label class="checkbox-inline">Yes<input style="margin-right: 5px;" name="setman"
                                        type="radio" value="yes" required></label>
                                <label class="checkbox-inline">No<input style="margin-right: 5px;" name="setman"
                                        type="radio" value="no" required></label>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-inline">Yes<input style="margin-right: 5px;" name="born_again"
                                        type="radio" value="yes" required></label>
                                <label class="radio-inline">No<input style="margin-right: 5px;" name="born_again"
                                        type="radio" value="no" required></label>
                            ...
                            <div class="form">
                                ...
                                <input type="text" class="form-control" name="yearbornagain"
                                    value="{{ old('yearbornagain') }}">
                            </div>
                            <div class="form-group">
                                <label for="spiritfilled">Are you filled with the Holy Ghost with the evidence of speaking
                                    in tongues?</label>
                                <label class="radio-inline">Yes<input style="margin-right: 5px;" name="holyghost"
                                        type="radio" value="yes" required></label>
                                <label class="radio-inline">No<input style="margin-right: 5px;" name="holyghost"
                                        type="radio" value="no" required></label>
                            </div>
                            <div class="form">
                            ...
                            <div class="form">
                                ...
                                <input type="text" class="form-control" name="departmentchurch"
                                    value="{{ old('departmentchurch') }}">
                            </div>
                            <div class="form-group">
                                <label for="spiritfilled">Are you a Pastor's Wife?</label>
                                <label class="radio-inline">Yes<input style="margin-right: 5px;" type="radio"
                                        name="pastor_wife" value="yes" required></label>
                                <label class="radio-inline">No<input style="margin-right: 5px;" type="radio"
                                        name="pastor_wife" value="no" required></label>
                            </div>

                            <div class="form">
                                <label for="sel1">Have you been denied admission for this REFINED before?</label>
                                <label class="checkbox-inline">Yes<input style="margin-right: 5px;" name="denied_admission"
                                        type="radio" value="yes" required></label>
                                <label class="checkbox-inline">No<input style="margin-right: 5px;" name="denied_admission"
                                        type="radio" value="no" required></label>
                            </div>
                            <div class="form">
                            ...
                            <div class="form-group">
                                ...
                                <label class="checkbox-inline">Yes<input style="margin-right: 5px;" name="take_refined"
                                        type="radio" value="yes" required></label>
                                <label class="checkbox-inline">No<input style="margin-right: 5px;" name="take_refined"
                                        type="radio" value="no" required></label>
                            </div>
                            <div class="form-group">
                                <label for="sel1">Did you complete and graduate from REFINED?</label>
                                <label class="checkbox-inline">Yes<input style="margin-right: 5px;" name="graduate_refined"
                                        type="radio" value="yes" required></label>
                                <label class="checkbox-inline">No<input style="margin-right: 5px;" name="graduate_refined"
                                        type="radio" value="no" required></label>
                            </div>
                            <div class="form">
                            ...
                            <div class="form">
                                ...
                                <input type="text" class="form-control" name="expectation"
                                    value="{{ old('expectation') }}" required>
                            </div>
                            ...
                            <div class="form"><button class="btn btn-primary btn-sh-primary" type="submit">Submit
