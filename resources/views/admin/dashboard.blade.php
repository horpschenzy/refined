                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">
                                    {{ auth()->user()->usertype == 'admin' ? 'Approved Application' : 'Applicants' }}
                                </h4>
                                    ...
                                    <table id="datatable-buttons"
                                        ...
                                        <tbody>
                                            @foreach ($applicants as $applicant)
                                                <tr>
                                                    <td> <img src="images/{{ $applicant->picture }}" alt="user-image"
                                                            class="avatar-xs me-2 rounded-circle" /></td>
                                                    ...
                                                    <td><span
                                                            class="badge rounded-pill bg-primary">{{ $applicant->prefer_com }}</span>
                                                    </td>
                                                    <td>
                                                        {{ $applicant->country }}
                                                    </td>
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                @if (auth()->user()->usertype == 'admin')
                                                                    <a class="dropdown-item"
                                                                        onclick="accept({{ $applicant->id }})">Accept</a>
                                                                    <a class="dropdown-item"
                                                                        onclick="pend({{ $applicant->id }})">Pend</a>
                                                                    <div class="dropdown-divider"></div>
                                                                    <a class="dropdown-item"
                                                                        onclick="reject({{ $applicant->id }})">Reject</a>
                                                                    <a class="dropdown-item"
                                                                        onclick="deleteApplicant({{ $applicant->id }})">Delete</a>
                                                                @endif
                                ...
                                <table class="table table-bordered border-primary mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Thursday</td>
                                            <td>June: 25th<br>
                                                July: 2nd, 9th, 16th, 23rd, 30th<br>
                                                August: 6th, 13th, 20th, 27th<br>
                                            </td>
                                            <td>6:00pm-8:00pm</td>
                                        </tr>
                                        <tr>
