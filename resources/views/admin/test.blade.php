            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form method="POST" action="/test" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <label for="text-input" class="col-md-2 col-form-label">Test</label>
                                <div class="col-md-10">
                        ...
                        <div class="text-center mb-3">
                            <button type="submit" class="btn btn-primary waves-effect waves-light w-50">Add Test
                            </button>
                        </div>
                    </form>
                    </div>
                        ...
                        <div class="card-body">
                            <table id="datatable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="dropdown dropdown-topbar d-inline-block">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    @if (auth()->user()->usertype == 'admin')
                                                    <a href="#edittest{{$test->id}}"    data-bs-toggle="modal" data-bs-target="#edittest{{$test->id}}" class="dropdown-item">Edit</a>
                                                    <a href="/view/result/{{$test->id}}" class="dropdown-item">Result</a>
                                                    <a class="dropdown-item" onclick="deleteTest({{ $test->id }})">Delete</a>
                                                    @else
                                                    <a href="/view/submissions/{{$test->id}}" target="_blank" class="dropdown-item">View Submissions</a>
                                                    @endif
                                                </div>
                                    ...
                                    <div class="modal fade" id="edittest{{$test->id}}" tabindex="-1" aria-labelledby="edittest" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h5 class="modal-title" id="assignToFamily">Edit {{ $test->topic }} </h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="/edit/test/{{ $test->id }}" method="post">
                                                        @csrf
                                                        <div class="card-body">
                                                            <input type="text" value="{{ $test->id }}" name="id" hidden>
                                                            <div class="mb-3 row">
                                                                <label for="text-input" class="col-md-4 col-form-label">Test</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control" required type="text" value="{{$test->topic}}" name="topic" id="text-input">
                                                                </div>
                                                            </div>
                                                            <div class="mb-3 row">
                                                                <label for="text-input" class="col-md-4 col-form-label">Url</label>
                                                                <div class="col-md-8">
                                                                    <input class="form-control" type="text" value="{{$test->url}}" name="url" id="text-input">
                                                                </div>
                                                            </div>
                                                            <div class="mb-3 row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <select name="status" required="" id="" class="form-select" aria-label="Default select example">
                                                                        <option value="{{ $test->status }}">{{ ucfirst($test->status) }}</option>
                    ...
                    if (delete_test) {
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                              ...
                              if(response) {
                                swal("Poof! Test Deleted Successfully!", {
                                    icon: "success", });
