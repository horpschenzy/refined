...
<tr style="border-collapse:collapse">
<td style="padding:0;Margin:0;padding-bottom:10px;padding-top:15px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;font-size:16px;text-align:justify">Thank you for accepting to be part of REFINED. <br> Please find below your login details to the refined website: <a href="https://refined.segunobadje.org/memberslogin">https://refined.segunobadje.org/memberslogin</a> <br><br> Your Registeration Number is: <strong>{{ $reg_no }}</strong> <br> Password: <strong>{{ $password }}</strong>  <br><br> You have been assigned to: <strong>{{ $family_circle }} Family circle</strong> <br> Click or copy the link to join: <strong>{{ $telegram_link}}</strong> <br><br> See you soon.
</p></td>
</tr>
<tr style="border-collapse:collapse">
